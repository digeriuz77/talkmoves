    ...
    >
      <div className="flex items-start gap-3 p-4">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-1.5 text-sm leading-snug text-white/90 sm:text-base">{message}</p>
        </div>
        <button
          type="button"
          onClick={onDismiss}
          className="shrink-0 rounded-lg p-2 text-white/40 transition-colors hover:bg-white/10 hover:text-white/80"
          aria-label="Dismiss"
        >
          <X className="h-4 w-4" />
        </button>
